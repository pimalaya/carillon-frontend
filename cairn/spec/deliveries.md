...
The deliveries page is the global live log across all of the active Carillon account's services — the "it works" surface, showing every signal and its webhook outcome as it happens, and never any content.
